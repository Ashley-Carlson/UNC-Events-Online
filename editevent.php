...
$(function() {
	...
	<form enctype="multipart/form-data" role="form" id="addevent" action="editevent.php" method="POST" background-COLOR="white">
		<div class="container">
			<body class="addevent">
	...
	<!-- takes text input for title, description, reserve -->
		<font color="black">
			...
			<input id="url_box" type="url" name="external_url1" value="<?php echo $event['external_url1'] ?>"><br>
			<input id="url_box" type="url" name="external_url2" value="<?php echo $event['external_url2'] ?>"><br>
			<input id="url_box" type="url" name="external_url3" value="<?php echo $event['external_url3'] ?>"><br>
