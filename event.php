...
?>
  <br><br>
    <div class="card">
      ...
      <p>More info found:</p>
      <?php if (isset($item['external_url1'])) { echo '<a href="' . $item['external_url1'] . '">' . $item['external_url1'] . '</a>'; }?>
      <?php if (isset($item['external_url2'])) { echo '<a href="' . $item['external_url2'] . '">'. $item['external_url2'] . '</a>'; }?>
      <?php if (isset($item['external_url3'])) { echo '<a href="' . $item['external_url3'] . '">' . $item['external_url3'] . '</a>'; }?>
      <br>
